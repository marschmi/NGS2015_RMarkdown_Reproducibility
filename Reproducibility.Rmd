...
2. **Git add** by checking the box under "staged" in the git screen.  
    +*(The git screen is in the same pane as the RStudio Environment and history).*  
...
4. Click **"Commit."**  
5. Perform a **Git Push** by clicking the bright green arrow, which is the "git Push" button.  
6. Make sure everything is pushed to the remote repository (the ) without any errors.  
...
- Resources from Dr. Jennifer Bryan's [Stats 545](http://stat545-ubc.github.io/git00_index.html).  
