...
- Titus Brown's [NGS Course](https://github.com/ngs-docs/angus)  
    ...
    + A [blog post from Titus](http://ivory.idyll.org/blog/tag/ngs-course.html) synthesizing the third week of the course.  
- Github for this website: [https://github.com/marschmi/NGS2015_RMarkdown_Reproducibility](https://github.com/marschmi/NGS2015_RMarkdown_Reproducibility)
...
- A course by Karl Broman at the University of Wisconsin-Madison on [Reproducible Research.](http://kbroman.org/Tools4RR/)  
...
- [Recent Atlantic Article by Ed Yong](http://www.theatlantic.com/health/archive/2015/08/psychology-studies-reliability-reproducability-nosek/402466/)
...
2. [R?](http://www.inside-r.org/download)  
...
- If the link for Ryan William's lesson does not work, please try here: [https://github.com/ngs-docs/angus/blob/2015/week3/visualizations/multivariate-tests/tests.md](https://github.com/ngs-docs/angus/blob/2015/week3/visualizations/multivariate-tests/tests.md)
...
- Resources from Jennifer Bryan's [Stats 545](http://stat545-ubc.github.io/git00_index.html).  
...
- I went to **Hampshire College** for undergrad and wrote my thesis on the [evolution of magnetotaxis in magnetotactic bacteria](http://www.ncbi.nlm.nih.gov/pubmed/22865076).  
...
#### Session Info  
[Karl Broman](http://kbroman.org/knitr_knutshell/pages/reproducible.html) recommends using the `session_info()` from the devtools package.
