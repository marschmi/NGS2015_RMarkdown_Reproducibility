...
- My dissertation is focused on the spatial and temporal distributions and activities of freshwater bacteria.  
    + Specifically, I work on the diversity of particle-associated (3-20 um) and free-living (0.22-3 um) bacteria within both small inland lakes and in Lake Michigan.  
    + So far I have been using 16S rRNA amplicon data at the DNA-level to study bacterial community composition.  
    + In the future, I hope to look at functional differences between the particle-associated and free-living bacterial fractions by using metatranscriptomics.
...
#### Within the Github Project we created earlier, let's make a file named "LastName-ProjectName-2015.Rmd" with html output
