...
4. <a href="https://git-scm.com/book/en/v2/Getting-Started-Installing-Git" target="_blank">Git?</a>  
    + Let's generate an SSH Key <a href="https://help.github.com/articles/generating-ssh-keys/" target="_blank">SSH key.</a>  
...
## Challenge 
1. Working within your new R Project "Bioinformatics_Reproducibility"  
2. Let's create a new directory called "data"
3. Download the <a href="http://tracykteal.github.io/R-genomics/02-starting-with-data.html">Ecoli_metadata.csv from Data Carpentry</a> into your data directory within your "Bioinformatics_reproducibility" repository.  
4. Create a new RMarkdown file.  
5. Time to start our project!

For example we can learn from some of the <a href="http://tracykteal.github.io/R-genomics/">data carpentry lesson</a> written by Kate Hertweck, Susan McClatchey, Tracy Teal, and Ryan Williams:
...
ggplot(metadata) +
  geom_bar(aes(x = genome_size), stat = "bin", binwidth=0.01)
